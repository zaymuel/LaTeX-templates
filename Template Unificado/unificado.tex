...
\usepackage[autostyle]{csquotes}  % fazer as aspas aparecerem corretamente
  \MakeOuterQuote{"}              % poder usar "aspas"
...
\usepackage{physics}    % physics things + derivatives; \dd, \dv
\usepackage{siunitx}    % standardization of si units

\usepackage{cancel}     % strikethrough cancelling on equations
...
% using unit vectors: \uvec{i}, \uvec{j}
...
% \begin{figure}[H]       % IMEDIATAMENTE AQUI
